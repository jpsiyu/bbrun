...
class Child extends Element {
    constructor(x, y) {
        ...
        super(x, y, radius)
        this.spriteNormal = new Sprite(2, 2, GameGlobal.g.resMgr.getImg('child-roll'), { frameUpdateTime: 1 })
        this.spriteWarrior = new Sprite(2, 2, GameGlobal.g.resMgr.getImg('warrior'), { frameUpdateTime: 0.2 })
            ...
            case macro.StateReachDoor:
                ...
                switch (this.mode) {
                    case macro.ChildModeDrink:
                        ...
                        this.img = GameGlobal.g.resMgr.getImg('drink')
    ...
    checkPosInFense(pos) {
        ...
        switch (this.mode) {
            case macro.ChildModeNormal:
                GameGlobal.g.map.fences.forEach(fence => {
